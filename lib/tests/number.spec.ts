...
describe('Numbers tests.', () => {
    ...
    it('999999999999999, precision 2 ➜ 999.99T', () => {
        chai.expect(Numbers.Humanify(999999999999999, { precision: 2 })).to.eql('999.99T')
    })
    it('9999999999999999, precision 2 ➜ NaN', () => {
        chai.expect(Numbers.Humanify(9999999999999999, { precision: 2 })).to.eql('NaN')
    })
    it('0.009, precision 3 ➜ 0.009', () => {
        chai.expect(Numbers.Humanify(0.009, { precision: 3 })).to.eql('0.009')
    })
    it('0.0009, precision 3 ➜ NaN', () => {
        chai.expect(Numbers.Humanify(0.0009, { precision: 3 })).to.eql('NaN')
    })
})
